...
namespace SocietiesManagementSystem.Forms
{
    public class AdminDashboardForm : Form
    {
        ...
        public AdminDashboardForm()
        {
            ...
            this.Text = "Admin Module - " + Session.CurrentUser?.Name;
        ...
        {
            int yPos = 50;
            AddButton("Create User", yPos, (s, e) => { new RegisterForm("Admin").Show(); }); yPos += 60;
            AddButton("Manage Users", yPos, (s, e) => LoadForm(new ManageUsersForm())); yPos += 60;
            AddButton("Manage Societies", yPos, (s, e) => LoadForm(new ManageSocietiesForm())); yPos += 60;
            AddButton("Assign Society Head", yPos, (s, e) => LoadForm(new AssignSocietyHeadForm())); yPos += 60;
            AddButton("Approve Events", yPos, (s, e) => LoadForm(new ApproveEventsForm())); yPos += 60;
            AddButton("Monitor Activities", yPos, (s, e) => LoadForm(new MonitorActivitiesForm())); yPos += 60;
            AddButton("University Reports", yPos, (s, e) => LoadForm(new UniversityReportsForm())); yPos += 60;
        }
